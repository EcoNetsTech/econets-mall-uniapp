<template>
	<!--  参考 groupon/list.vue 和 seckill/list.vue 界面，调整下头部，就是从 5 到 11 行的  -->
...
<script setup>
	...
	async function getBargainList() {
		//  loading 和 loadTitle 改成现在这个项目的风格，包括组件使用 uni-load-more
	...
	function openSubscribe(e) {
		console.log('跳转')
		console.log(e)
		//  参考 pages/pay/result.vue 页面的 subscribeMessage 方法，写订阅逻辑。
		sheep.$router.go(e)
		return;
		let page = e;
		// #ifndef MP
...
<style lang='scss' scoped>
	...
	.bargain-list .header {
		/*  此处原来采用base64 但是过长编辑到小程序卡死 目前采用网络地址 需解决 */
